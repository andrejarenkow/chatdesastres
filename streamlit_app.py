...
if prompt_usuario:
    prompt = 'Este dataframe é um formulário de municípios que estão passando por situação de desastre. Os municípios são divididos por Coordenadorias Regiinais de Saúde (CRS)' + prompt_usuario + ' Dê a resposta em markdown. Essa resposta será mostrada em um webapp do streamlit'
